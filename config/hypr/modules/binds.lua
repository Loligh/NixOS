...
hl.bind("SUPER + SHIFT + U", hl.dsp.window.move({ workspace = "1", follow = true }))
hl.bind("SUPER + SHIFT + I", hl.dsp.window.move({ workspace = "2", follow = true }))
hl.bind("SUPER + SHIFT + O", hl.dsp.window.move({ workspace = "3", follow = true }))
hl.bind("SUPER + SHIFT + P", hl.dsp.window.move({ workspace = "4", follow = true }))

hl.bind("SUPER + SHIFT + ALT + U", hl.dsp.window.move({ workspace = "1", follow = false }))
hl.bind("SUPER + SHIFT + ALT + I", hl.dsp.window.move({ workspace = "2", follow = false }))
hl.bind("SUPER + SHIFT + ALT + O", hl.dsp.window.move({ workspace = "3", follow = false }))
hl.bind("SUPER + SHIFT + ALT + P", hl.dsp.window.move({ workspace = "4", follow = false }))
